...
$ time docker run --rm -ti --user=$USER:$USER --workdir=/home/$USER -v $PWD/output:/home/$USER/output rubuschl/de1soc-buildroot:20191104161353
```
...
```
$ docker run --rm -ti --user=$USER:$USER --workdir=/home/$USER -v $PWD/output:/home/$USER/output rubuschl/de1soc-buildroot:20191104161353 /bin/bash
```
